...
- **Phase 10 (firm UX)** — opens next (Phase 9 merged 2026-06-15). Kickoff/sequencing plan drafted: `docs/PHASE_10_KICKOFF_PLAN.md` (5 checkpoints; the deferred Phase 9 follow-ons #102/#103 + webhook-firm-branch deploy + set-firm-access/delete-firm + create-workspace `firm_id` are folded into CP3/CP4b). **5 decisions left OPEN** in that doc (firm_activity_log CHECK, FirmContext vs AppContext, fold #103 in, plain vs materialized inbox view, billing_summary_mode line items) — resolve at Phase 10 start. Column-level source: `docs/PHASE_10_BUILD_SPEC.md`.
