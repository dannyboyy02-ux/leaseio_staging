...
### Item #29: `enforce_workspace_entitlement_guard` trigger missing from prod — **FIX READY 2026-05-22, pending staging/prod apply** (billing-bypass vector, severity High)
