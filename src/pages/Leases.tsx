...
export default function Leases() {
  ...
  const getPropertyAddress = (lease: LeaseRow): string => {
    ...
    return (json?.address as string) || lease.filename;
  };
                        ...
                        >
                          <TableCell className="font-medium">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="truncate max-w-[200px]">{getPropertyAddress(lease)}</span>
                            </div>
                          </TableCell>
                          <TableCell>
                            <span className="truncate max-w-[150px] block">{lease.tenant_name || "—"}</span>
                          </TableCell>
                          <TableCell className="hidden lg:table-cell text-muted-foreground">
                            <span className="truncate max-w-[150px] block">{lease.landlord_name || "—"}</span>
                          </TableCell>
