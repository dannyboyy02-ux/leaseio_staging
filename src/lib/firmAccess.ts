// Firm-layer effective-access logic (Phase 9). Pure, dependency-free.
//
// ⚠️ MIRROR: keep byte-for-byte in sync with
// `supabase/functions/_shared/firm_access.ts` (the Deno copy used by edge
// functions). `check-mirror-parity.mjs` enforces this.
//
...
// a firm_admin explicitly added to a child as 'viewer' is 'viewer' there.
