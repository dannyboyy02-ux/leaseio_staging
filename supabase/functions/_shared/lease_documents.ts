// ─────────────────────────────────────────────────────────────────────────
// Pure document-tracking helpers — Deno mirror.
//
...
// is imported by the Phase 4 edge functions (upload-lease-document,
// escalate-to-concept-approver, advance-to-final-review). The Node copy
// is imported by the frontend and by vitest unit tests in
// src/lib/__tests__/leaseDocuments.test.ts.
//
